...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        switch (Constants.currentMode) {
            case REAL:
                ...
                manipulator = new Manipulator(new ManipulatorIOCTRE(), () -> driver.leftBumper().getAsBoolean());
                // elevator =
                // new Elevator(
                // new ElevatorIO() {},
                // () -> mech.getLeftY());
    ...
    private void configureBabyBindings() {
        ...
        driver
                .povLeft()
                .onTrue(
                        superstructure.setWantedStateCommand(WantedState.PRE_CLIMB).ignoringDisable(true));

        driver
                .povRight()
                .onTrue(
                        superstructure.setWantedStateCommand(WantedState.CLIMB).ignoringDisable(true));
