...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    elevator.setDefaultCommand(
        new ElevationManual(
            elevator, () -> -joystick.getRawAxis(XboxController.Axis.kRightY.value)));

    joystick.leftBumper().onTrue(new InstantCommand(() -> elevator.setDistance(Meters.of(0))));
    joystick.rightBumper().onTrue(new InstantCommand(() -> elevator.setDistance(Meters.of(1))));
