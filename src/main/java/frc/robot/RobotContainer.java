...
public class RobotContainer {
    ...
    /** Port 5 */
    private final TunableController testing = new TunableController(5)
            .withControllerType(TunableControllerType.QUADRATIC)
            .withOutputAtDeadband(0.025)
            .withDeadband(0.125);
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand(
                ...
                new InstantCommand(() -> TargetingComputer.setAligningWithAlgae(true))
                        ...
                        .andThen(
                                new InstantCommand(
                                        () -> TargetingComputer.setAlliance(Robot.getAlliance() ? false : true))
    ...
    private void configureBindings() {
        ...
        // new Trigger(() -> funnel.getMode() == FunnelMode.INTAKE &&
        // funnel.isAtTarget())
                                        ...
                                        Units.degreesToRadians(
                                                TargetingComputer.getCurrentTargetBranch()
                                                        .getTargetingAngle()))
                                                                ...
                                                                .getDegrees()) < TargetingComputer.alignmentAngleTolerance
                                // && drivetrain
                ...
                .onFalse(
                        new InstantCommand(() -> claw.lockRoller())
                                .alongWith(
                                        elevator
                                                .INTAKE()
                                                .unless(() -> targetReef.getAsBoolean()
                        ...
                        new InstantCommand(() -> TargetingComputer.setAligningWithAlgae(true))
                                ...
                                .alongWith(
                                        new ElevatorToTargetLevel(elevator)
                                                ...
                                                .onlyIf(() -> drivetrain.isInAlignmentZone()
                                                        && targetReef.getAsBoolean())
                                                .unless(
                                                        () -> TargetingComputer.getSourceTargetingAngle(
                                                                drivetrain.getPose()) == TargetingComputer.Targets.NET
                                                                        .getTargetingAngle())));
        ...
        grabAlgae
                .and(
                        () -> !claw.hasAlgae()
                                ...
                                && drivetrain
                                        .getDistanceToPose(TargetingComputer.getCurrentTargetBranchPose())
                                        .getNorm() < Units.inchesToMeters(3)
                                && elevator.isAtTarget()
                                && claw.isAtTarget()
        ...
        grabAlgae
                ...
                .and(
                        () -> claw.hasAlgae()
                                && !targetReef.getAsBoolean()
                                && TargetingComputer.getSourceTargetingAngle(
                                        drivetrain.getPose()) != TargetingComputer.Targets.NET.getTargetingAngle())
                .onTrue(claw.PROCESSOR());
                ...
                .onFalse(
                        elevator
                                ...
                                .alongWith(
                                        new InstantCommand(() -> TargetingComputer.setAligningWithAlgae(false))
                                                .unless(() -> claw.hasAlgae()))
                                .alongWith(new TempCommand(drivetrain)))
                .and(
                        () -> !drivetrain.isInAlignmentZone()
                                || Math.abs(
                                        new Rotation2d(
                                                Units.degreesToRadians(
                                                        TargetingComputer.getCurrentTargetBranch()
                                                                .getTargetingAngle()))
                                                                        .minus(drivetrain.getPose().getRotation())
                                                                        .getDegrees()) > 5)
                .onTrue(new PathFind(drivetrain))
                .and(() -> Pathfinding.isNewPathAvailable())
                .onTrue(new PathFind(drivetrain));
        // drivetrain.applyRequest(
        // () ->
        // drive
        ...
        targetReef // Robot moves to the current target
                                                ...
                                                MaxSpeed.times(
                                                        (Math.abs(
                                                                TargetingComputer.getCurrentTargetBranchPose()
                                                                        .getX()
                                                                        - drivetrain.getPose().getX()))
                                                                * alignP > TargetingComputer.maxAlignSpeed
                                                                        ? Math.copySign(
                                                                                ...
                                                                                (TargetingComputer
                                                                                        ...
                                                                                        - drivetrain.getPose().getX()))
                                                                        : (TargetingComputer
                                                                                .getCurrentTargetBranchPose().getX()
                                                                                - drivetrain.getPose().getX())
                                                                                * alignP)
                                                                ...
                                                                * alignP > TargetingComputer.maxAlignSpeed
                                                                        ? Math.copySign(
                                                                                ...
                                                                                (TargetingComputer
                                                                                        ...
                                                                                        - drivetrain.getPose().getY()))
                                                                        : (TargetingComputer
                                                                                .getCurrentTargetBranchPose().getY()
                                                                                - drivetrain.getPose().getY())
                                                                                * alignP)
                                                        .times(Robot.getAlliance() ? -1 : 1))
                                        .withRotationalRate(
                ...
                .and(
                        () -> drivetrain
                                .getDistanceToPose(TargetingComputer.getCurrentTargetBranchPose())
                                .getNorm() < TargetingComputer.alignmentTranslationTolerance
                                && elevator.isAtTarget()
        ...
        targetSource
                .and(
                        () -> claw.hasAlgae()
                                && TargetingComputer.getSourceTargetingAngle(
                                        drivetrain.getPose()) == TargetingComputer.Targets.PROCESSOR.getTargetingAngle()
                                && grabAlgae.getAsBoolean())
        ...
        targetSource
                .and(
                        () -> claw.hasAlgae()
                                && TargetingComputer.getSourceTargetingAngle(drivetrain
                                        .getPose()) == TargetingComputer.Targets.FAR_PROCESSOR.getTargetingAngle()
                                && grabAlgae.getAsBoolean())
                .onTrue(elevator.INTAKE())
                .whileTrue(
                        drivetrain.applyRequest(
