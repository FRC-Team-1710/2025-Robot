...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        new Trigger(() -> drivetrain.isNearProcessor()).and(targetSource).and(() -> claw.hasAlgae())
                .onTrue(claw.PROCESSOR()).onFalse(claw.IDLE().unless(targetSource));
        ...
        targetReef // Robot moves to the current target
                ...
                .whileTrue(
                        drivetrain.applyRequest(
                                () -> drive
                                        .withVelocityX(
                                                MaxSpeed.times((TargetingComputer.getCurrentTargetBranchPose().getX()
                                                        ...
                                                        * alignP > TargetingComputer.maxAlignSpeed
                                                                ...
                                                                : (TargetingComputer.getCurrentTargetBranchPose().getX()
                                                                        ...
                                                                        * alignP))
                                        .withVelocityY(
                                                MaxSpeed.times((TargetingComputer.getCurrentTargetBranchPose().getY()
        ...
        bumpCoral
                .onTrue(new InstantCommand(() -> funnel.setRollerPower(-0.075))
