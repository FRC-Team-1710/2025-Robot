...
public class ManipulatorIOCTRE implements ManipulatorIO {
  ...
  @NotLogged final StatusSignal<Angle> position = manipulator.getPosition();
  @NotLogged final StatusSignal<AngularVelocity> velocity = manipulator.getVelocity();
  @NotLogged final StatusSignal<Voltage> appliedVolts = manipulator.getMotorVoltage();
  @NotLogged final StatusSignal<Current> current = manipulator.getSupplyCurrent();
